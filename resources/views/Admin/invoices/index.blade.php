...
@section('title', __('reports.invoices'))
                        ...
                        <div class="text-center">
                            <form action="{{route('admin.invoices.index')}}" method="GET">
                                ...
                                <input data-provide="datepicker" data-date-autoclose="true" class="w-25 p-1 mb-2"
                                       name="from" data-date-format="yyyy-mm-dd" value="{{old('from')}}"
                                       placeholder="@lang('reports.from')" autocomplete="off">
                                <input data-provide="datepicker" data-date-autoclose="true" class="w-25 p-1 mb-2"
                                       name="to" data-date-format="yyyy-mm-dd" value="{{old('to')}}"
                                       placeholder="@lang('reports.to')"
                                       autocomplete="off">
