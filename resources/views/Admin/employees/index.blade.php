...
@section('content')
    <div class="row justify-content-end">
        <div class="col-3">
            <a class="btn rounded w-100 btn-success buttons-html5" href="{{url('employees/create')}}">
                <span>@lang('employees.add_new_employee')</span>
            </a>
        </div>
    </div>
                    ...
                    <div class="table overflow-auto">
                        <table class="table table-striped table-hover dataTable js-exportable">
                            ...
                            <tr>
                                ...
                                <th>@lang('employees.salary')</th>
                                <th>@lang('employees.start_date')</th>
