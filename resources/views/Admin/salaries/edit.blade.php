            ...
            <div class="body">
                <form method="POST" action="{{route('admin.salaries.update',['salary'=>$salary->id])}}"
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control key" name="commission"
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <label for="deduction">@lang('employees.transportation')</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><b>@lang('general.currency')</b></span>
                                    </div>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <label for="deduction">@lang('employees.social_ins')</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><b>@lang('general.currency')</b></span>
                                    </div>
                                    <input type="number" class="form-control key" name="social_ins"
                                           value="{{$salary->social_ins}}">
                                </div>
                            </div>
                        </div>
                    </div>
